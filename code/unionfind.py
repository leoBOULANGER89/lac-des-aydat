"""
Code pris de la bibliotèque unionfind trouvable sur https://github.com/hagai-helman/unionfind/blob/main/unionfind.py
...
class UnionFind(object):
    r"""Union-find disjoint sets datastructure.
